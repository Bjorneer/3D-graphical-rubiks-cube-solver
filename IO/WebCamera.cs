...
{
    internal class WebCamera : ISampleGrabberCB, IDisposable
    {
        ...
        public WebCamera(int iDeviceNum, int iWidth, int iHeight, short iBPP, Control hControl)
        {
            DsDevice[] capDevices;
        ...
        public WebCamera(DsDevice device, int iWidth, int iHeight, short iBPP, Control hControl)
        {
            try
            {
                // Set up the capture graph
                SetupGraph(device, iWidth, iHeight, iBPP, hControl);
                // tell the callback to ignore new images
                m_PictureReady = new ManualResetEvent(false);
                Name = device.Name;
            }
